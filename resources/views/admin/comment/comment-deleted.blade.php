...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 评论管理 <span class="c-gray en">&gt;</span> 评论回收站 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	...
	<div class="mt-20">
		<table class="table table-border table-bordered table-hover table-bg table-sort">
			...
			<tbody>
				...
				<tr class="text-c">
					<td>{{$comment->id}}</td>
					<td><a href="javascript:;" onclick="member_show('张三','member-show.html','10001','360','400')"><i class="avatar size-L radius"><img alt="" src="/{{$comment->user->avatar}}" onerror="this.src='static/h-ui/images/ucnter/avatar-default-S.gif'"></i></a></td>
...
function EnterPress(e){ //传入 event
    ...
    if(e.keyCode == 13){
        ...
        // if(keyword){
            window.location.href="/admin/comment/deleted?keyword="+keyword;
        // }
    }
}
function search(){
