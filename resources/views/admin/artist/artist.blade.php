...
<div class="pos-a" style="width:200px;left:0;top:0; bottom:0; height:100%; border-right:1px solid #e5e5e5; background-color:#f5f5f5; overflow:auto;">
	...
	<div class="blk">
		<a href="/admin/artist" onclick="" class="" id="all"><li>全部</li></a>
			...
			<div class="blk">
				...
				@if($category->son)
					@foreach($category->son as $cate)
						<a href="/admin/artist?category_id={{$cate->id}}" id="cate{{$cate->id}}" onclick="" class=""><li>{{$cate->catename}}</li></a>
					@endforeach
				@endif
				</div>
				<hr>
...
<div style="margin-left:200px;">
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 音乐管理 <span class="c-gray en">&gt;</span> 歌手列表 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
			...
			<table class="table table-border table-bordered table-bg table-hover table-sort">
				...
				<tbody id="song_list">
					...
					<tr class="text-c va-m">
						...
						<td>
							<a style="text-decoration:none" onClick="artist_show('{{$artist->name}}','/admin/artist?detail?id={{$artist->id}}')" href="javascript:;"> <b class="text-success">{{$artist->name}}  </b></a>
							&nbsp;<a style="text-decoration:none" onClick="artist_album('{{$artist->name}}的专辑','/admin/album?id={{$artist->id}}')"  href="javascript:;" title="专辑"><i class="Hui-iconfont">&#xe639;</i></a>&nbsp;
							<a style="text-decoration:none" onClick="artist_song('{{$artist->name}}的歌曲','/admin/song?artist_id={{$artist->id}}')"  href="javascript:;" title="歌曲"><i class="Hui-iconfont">&#xe60f;</i></a>
						</td>
						...
						<td class="td-manage">
							...
							<a style="text-decoration:none" class="ml-5" onClick="artist_edit('编辑','/admin/artist/update?id={{$artist->id}}')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
...
<script type="text/javascript">
    ...
    function EnterPress(e){ //传入 event
        ...
        if(e.keyCode == 13){
            ...
            if(keyword){
                window.location.href="/admin/artist?keyword="+keyword;
            }
        }
    }
    function search(){
...
function product_shenqing(obj,id){
    ...
    /*歌手-专辑*/
    function artist_album(title,url){
        var index = layer.open({
            type: 2,
            title: title,
            content: url
    ...
    /*歌手-专辑*/
    function artist_song(title,url){
        var index = layer.open({
            type: 2,
            title: title,
            content: url
...
/*歌手-编辑*/
function artist_edit(title,url){
	var index = layer.open({
		type: 2,
		title: title,
		content: url
