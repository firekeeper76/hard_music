...
<body>
    ...
    <div style="width:40%">
      ...
      <form class="layui-form" action="" method="post" enctype="multipart/form-data" onsubmit="return false" id="form-add">
        <input type="hidden" name="cover" id="cover" class="layui-form-item" value="">
        <input type="hidden" name="avatar" id="avatar" class="layui-form-item" value="">
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            ...
            <h4 id="pre_tips" style="display: none;">封面效果</h4>
