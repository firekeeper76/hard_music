...
<body>
    ...
    <div style="width:40%">
      ...
      <form class="layui-form"  method="post" enctype="multipart/form-data" onsubmit="return false"  id="form-add">
        ...
        <input type="hidden" name="" id="src_to" autocomplete="off" placeholder="" class="layui-input">
        <div class="layui-form-item">
          ...
          <div class="layui-inline">
            ...
            <div class="layui-input-inline">
              <input class='layui-input' type="text" id="src_to_id">
            </div>
          </div>
        </div>
        {{--<div class="layui-form-item">--}}
        ...
        <div class="layui-form-item">
          ...
          <div class="layui-input-block">
            <input type="text" id="bg_color" autocomplete="off" placeholder="" class="layui-input">
          </div>
        </div>
        <div style="height:20px;"></div>
    ...
    <script>
      ...
      function add(){
          ...
          $.ajax({
              ...
              data: {'src':src,'src_to':src_to,'bg_color':bg_color},
